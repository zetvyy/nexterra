          ...
          <div className="container mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-gray-700 rounded-md p-6">
                ...
                <p className="text-gray-300">
                  Nexterra adalah platform pembelajaran digital yang menyediakan
                  eBook gratis, webinar, dan ecourse praktis untuk membantu
                  pengusaha, mahasiswa, karyawan, dan wiraswasta mengembangkan
                  skill dan bisnis mereka.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                  ❓ Apakah semua materi di Nexterra gratis?
                </h4>
                <p className="text-gray-300">
                  Banyak materi kami tersedia secara gratis, terutama eBook dan
                  beberapa webinar. Untuk materi premium seperti ecourse
                  tertentu, ada biaya yang sangat terjangkau.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                  ❓ Siapa saja yang bisa ikut belajar di Nexterra?
                </h4>
                <p className="text-gray-300">
                  Semua orang! Mulai dari pemilik bisnis, mahasiswa yang ingin
                  upgrade skill, karyawan yang ingin naik level, hingga siapa
                  pun yang ingin terus berkembang.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                ...
                <p className="text-gray-300">
                  Untuk beberapa webinar dan ecourse, ya, tersedia sertifikat.
                  Informasi tentang sertifikat akan dicantumkan di masing-masing
                  halaman produk.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                  ❓ Bagaimana cara mengikuti webinar atau mengunduh eBook?
                </h4>
                <p className="text-gray-300">
                  Cukup daftar di website Nexterra, lengkapi data pribadi, dan
                  kamu bisa langsung akses semua materi yang tersedia di akunmu.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                  ❓ Apakah bisa refund jika saya berubah pikiran?
                </h4>
                <p className="text-gray-300">
                  Tidak bisa. Karena seluruh produk digital langsung bisa
                  diakses setelah pembayaran. Kecuali terjadi double transaksi,
                  maka kamu berhak mendapat refund penuh.
                </p>
              </div>
              <div className="bg-gray-700 rounded-md p-6">
                <h4 className="font-semibold text-lg mb-2">
                ...
                <p className="text-gray-300">
                  Tentu! Kami menjaga data pribadi kamu sesuai dengan kebijakan
                  privasi. Data hanya digunakan untuk keperluan layanan, dan
