        ...
        <div className="bg-gray-100 shadow-md rounded-lg px-8 py-10 w-full max-w-md">
          ...
          {isRegistering ? (
              ...
              <form onSubmit={handleRegisterSubmit}>
                ...
                <div className="relative mb-6">
                  ...
                  <input
                    ...
                    onChange={handleRegisterChange}
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline pr-10" // pr-10 untuk ruang ikon
                    required
                  />
                  <button
                    type="button"
                    ...
                    className="text-purple-500 absolute inset-y-7 right-0 pr-3 flex items-center text-sm leading-5 h-9 w-9"
                    aria-label={
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="text-purple-500 absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 h-9 w-9"
                      aria-label={
                        showConfirmPasswordRegister
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <div className="mb-6">
                <label
                  htmlFor="password-login" // ID unik
                  className="block text-gray-700 text-sm font-bold mb-2"
                >
                  Password
                </label>
